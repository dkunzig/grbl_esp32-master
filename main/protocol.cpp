...
void protocol_exec_rt_system()
{
  ...
  if (rt_exec) { // Enter only if any bit flag is true
	...
	switch (rt_exec) {
	case 1: grbl_send(0, "message: EXEC_ALARM_HARD_LIMIT"); break;
	case 2: grbl_send(0, "message: EXEC_ALARM_SOFT_LIMIT"); break;
	case 3: grbl_send(0, "message: EXEC_ALARM_ABORT_CYCLE"); break;
	case 4: grbl_send(0, "message: EXEC_ALARM_PROBE_FAIL_INITIAL"); break;
	case 5: grbl_send(0, "message: EXEC_ALARM_PROBE_FAIL_CONTACT"); break;
	case 6: grbl_send(0, "message: EXEC_ALARM_HOMING_FAIL_RESET"); break;
	case 7: grbl_send(0, "message: EXEC_ALARM_HOMING_FAIL_DOOR"); break;
	case 8: grbl_send(0, "message: EXEC_ALARM_HOMING_FAIL_PULLOFF"); break;
	case 9: grbl_send(0, "message: EXEC_ALARM_HOMING_FAIL_APPROACH"); break;
	}
